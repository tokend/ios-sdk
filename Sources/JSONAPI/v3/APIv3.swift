...
public class APIv3 {
    ...
    public private(set) lazy var liquidityPoolsApi: LiquidityPoolsApiV3 = { return create() }()
    ...
    public private(set) lazy var plaidKYCApi: PlaidIntegrationApiV3 = { return create() }()
    #endif
